...
APP_EVALUATION_DIR = REPORTS_DIR / "app_evaluation"
...
def build_document(
    ...
    document.add_paragraph(
        "This report summarizes the current machine-learning model and application validation results for the fish kiln monitoring system. "
    ...
    document.add_paragraph(
        ...
        "It should be presented as synthetic demonstration data until real experimental drying trials are collected and used for retraining."
    )
