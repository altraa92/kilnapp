...
def main() -> None:
    ...
    add_note(
        document,
        "Be honest: the current model is trained on synthetic demonstration data generated by train_model.py. It is a prototype workflow. The next academic improvement is to collect real kiln experiment data and retrain the model.",
    )
    ...
    add_table(
        ...
        [
            [
                ...
                "For this prototype, I generated a synthetic dataset using train_model.py. It has 2100 rows and simulates fish drying behavior using moisture, weight, temperature, humidity, and elapsed time assumptions.",
            ],
            [
            ...
            [
                "Why Random Forest?",
                "Because drying is affected by several non-linear factors. Random Forest handles non-linear relationships and mixed features well for a prototype.",
            ],
            [
                "Why is R2 so high?",
